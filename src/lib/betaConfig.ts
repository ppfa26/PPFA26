...
//   - 가격은 정식 오픈가(29,900원)만 "정식 오픈 예정가"로 앵커링 노출
...
/** 정식 오픈가 (정식 유료 전환 시 판매가) — 1회성 결제. 자문+SaaS 전환 전략에 맞춰 29,900원으로 통일(대표님 요청) */
export const OFFICIAL_PRICE = 29900;
export const OFFICIAL_PRICE_LABEL = "29,900원";
