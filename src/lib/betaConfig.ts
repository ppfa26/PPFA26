...
//   - 가격은 정식 오픈가(49,700원)만 "정식 오픈 예정가"로 앵커링 노출
...
/** 정식 오픈가 (정식 유료 전환 시 판매가) - 1회성 결제. 49,700원으로 통일(대표님 요청, C안) */
export const OFFICIAL_PRICE = 49700;
export const OFFICIAL_PRICE_LABEL = "49,700원";
