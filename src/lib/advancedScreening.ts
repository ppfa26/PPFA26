...
export const PRE_FOUNDER_PROGRAMS: PreFounderProgram[] = [
  {
    ...
    detail: "사업화 자금 + 창업교육 + 멘토링. 창업패키지는 대부분 매년 초(1~3월 상반기)에 몰려 있어요. 예비창업패키지는 보통 2월경 공고, K-Startup에서 온라인 신청.",
  ...
  },
  {
    ...
    detail: "사업화 자금 + 창업기업 성장 프로그램. 주관기관(대학·기관)별 특화 지원. 보통 매년 초(1~2월경) 공고되니 연초에 미리 준비해 두세요. K-Startup 신청.",
  ...
  },
  {
    ...
    detail: "사업모델 고도화 + 사업화 자금 + 성장 지원. 데스밸리 극복 지원. 연 1회, 대부분 매년 초(1~2월경) 공고되는 상반기 집중 사업이에요. K-Startup 신청.",
  ...
  },
  {
    ...
    detail: "재창업 사업화 자금 + 재기 교육·멘토링. 실패 경험을 성장으로. 다른 창업패키지와 마찬가지로 상반기(보통 2~3월경)에 공고되는 경우가 많아요. K-Startup 신청.",
  ...
  },
  {
    ...
    detail: "중소벤처기업진흥공단 운영. 사업화자금 + 입교(집중보육) + 정책자금 연계. 매년 초(1~2월경) 접수하는 상반기 집중 사업이라 연초에 서두르는 게 유리해요.",
