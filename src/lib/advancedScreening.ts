...
const FUND_PLAIN_MEANINGS: { match: string; plain: string }[] = [
  { match: "소공인특화자금", plain: "제조·수출 등 '제조업' 소공인 전용 자금이에요" },
  ...
  { match: "일반경영안정자금", plain: "일반적인 모든 운영자금이 필요할 때 받는 가장 기본의 정책자금이에요." },
  ...
  // 강한소상공인·로컬크리에이터 선정 기업 전용 (긴 키워드라 아래 '혁신형' 일반 항목보다 우선 매칭)
  { match: "혁신성장촉진자금 (혁신형) - 강한소상공인·로컬크리에이터", plain: "강한소상공인 혹은 로컬크리에이터 인증을 받은 소상공인 전용이에요." },
  // 대환대출: 고금리 대출을 저금리 정책자금으로 갈아타는 상품
  { match: "대환대출", plain: "7% 이상 고금리 대출을 사용 중이시면 가능한 대환 대출 상품이에요." },
  { match: "혁신성장촉진자금 (혁신형)", plain: "매출이 쑥쑥 크는 성장형 소상공인용 자금이에요" },
  { match: "중소기업_정책자금", plain: "중소기업이 운영비·설비에 쓰는 대표 정책자금이에요" },
  // 기술보증기금 창업기업 보증 (창업 7년 이내)
  { match: "청년창업기업보증", plain: "만 39세 이하 청년 대표님이 창업 7년 안에 기술력으로 보증받는 자금이에요(보증료 감면 우대)." },
  { match: "기술창업보증", plain: "기술·아이디어로 창업한 7년 이내 기업이 보증받는 자금이에요." },
