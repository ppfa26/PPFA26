...
export const SUPPORT_PROGRAMS: SupportProgram[] = [
  {
    ...
    desc: "청년 채용·고용 유지 시 인건비 일부를 지원하는 정부 고용장려금입니다.",
  ...
  },
  {
    ...
    desc: "근로자 10명 미만 사업장의 월보수 270만원 미만 직원 고용보험·국민연금료를 최대 36개월간 80% 지원합니다.",
  ...
  },
  {
    ...
    desc: "연매출 1억 400만원 미만·영업 중인 소상공인의 고정비(4대보험·공과금)를 최대 25만원 카드포인트로 지원합니다.",
  ...
  },
  {
    ...
    site: "www.work24.go.kr",
    url: "https://www.work24.go.kr/cm/c/f/1100/selecPolicyList.do?concTrgtSecd=EBQ01",
    desc: "5인 이상 기업이 청년(만 15~34세)을 정규직 채용·6개월 유지 시 1년간 최대 720만원을 지원합니다.",
