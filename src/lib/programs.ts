...
export const PROGRAMS: Program[] = [
  {
    ...
    summary:
      "소상공인의 경영 안정을 위한 저금리 정책자금 융자(은행 대리대출). 신용점수 제한·사전 교육 요건이 없어 대부분의 소상공인이 신청할 수 있습니다.",
    target: ["소상공인", "개인사업자", "신용양호", "매출없음", "1억미만"],
    amount: "업체당 최대 7,000만원 (기준금리 +0.6%p)",
    applyUrl: "https://ols.sbiz.or.kr/",
    applySite: "소상공인정책자금 (OLS)",
    docs: ["사업자등록증", "소상공인 확인", "국세·지방세 완납증명", "매출 증빙(부가세과세표준증명 등)"],
    strategy:
      "업력과 무관하게 소상공인기본법상 소상공인이면 신청 가능합니다. 세금 체납이 있으면 반드시 완납 후 신청하세요. (신용점수 839점 이하라면 '신용취약소상공인자금(직접대출)'이 별도로 유리할 수 있습니다.)",
    relatedDocIds: ["d16", "d19", "d34"],
  },
  {
    ...
    organization: "소상공인시장진흥공단",
    summary:
      "NCB 개인신용평점 839점 이하 중·저신용 소상공인을 위한 소진공 직접대출. 신청 전 '신용관리교육' 사전 이수가 필수입니다.",
    target: ["소상공인", "개인사업자", "신용취약", "담보없음"],
    amount: "업체당 최대 3,000만원 (기준금리 +1.6%p)",
    applyUrl: "https://ols.sbiz.or.kr/",
    applySite: "소상공인정책자금 (OLS)",
    docs: [
      "사업자등록증명",
      "신용관리교육 이수증(소상공인 지식배움터)",
      "국세·지방세 완납증명",
      "기업현황 및 사업계획서",
    ],
    strategy:
      "① 반드시 신청 전에 '소상공인 지식배움터(edu.sbiz.or.kr)'의 신용회복위원회 신용관리교육을 이수하세요(미이수 시 접수 불가). ② 업력 90일 이상, 상시근로자 5인 미만(제조·건설·운수·광업은 10인 미만) 요건을 확인하세요. ③ 대출 후 자금 사용내역 점검이 있으므로 용도에 맞게 사용하세요.",
    relatedDocIds: ["d02", "d06", "d16", "d19"],
  },
  {
    id: "kosmes-fund",
    category: "정책자금",
