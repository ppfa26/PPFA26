...
export const STEP2_FIELDS = {
  ...
  currentInstitutions: {
    label: "현재 이용 중인 정책기관 (복수 선택 · 없으면 넘어가기)",
    opts: [
      "소상공인시장진흥공단",
      "중소벤처기업진흥공단",
      "신용보증재단",
...
export const STEP3_CONDITIONAL_FIELDS = {
  ...
  revenueGrowth2y: {
    label: "최근 사업장 연매출이 2년 10% 연속 상승하셨나요?",
    hint: "예: 부과세과세표준증명원 혹은 재무제표상 2년 연속 10% 연매출 상승한 경우 체크",
  ...
  govSelected: {
    label: "정부 선정 프로그램(강한소상공인·백년가게·백년소공인·TIPS 등)에 선정된 적 있으신가요?",
