...
// ── 1단계 · 기본 정보 ─────────────────────────────────────────
export const STEP1_TITLE = "1단계 · 사업장 기본 정보 · [1/3]";
...
export const STEP2_GROUP_STRENGTH = "🏅 우리 기업의 강점 [있으면 승인에 더 유리해요]";
...
// ── 3단계 · 현재 이용 현황 및 특이사항 ──────────────────────────
export const STEP3_TITLE = "3단계 · 맞춤 매칭 · 결격사유 확인 · [3/3]";
...
export const STEP3_FIELDS = {
  ...
  certifications: {
    label: "특허·인증 보유 여부",
    hint: "보유한 것을 모두 선택하세요. 없으면 '없음' [복수 선택 가능]",
  ...
  bankruptcy: {
    label: "대표자 회생·파산 상태",
    hint: "면책·인가가 완료되면 3년 경과 후 정책자금 신청이 가능합니다.",
