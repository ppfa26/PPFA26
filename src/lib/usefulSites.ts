...
export const USEFUL_SITE_CATEGORIES: SiteCategory[] = [
  ...
  },
  {
    ...
    sites: [
      ...
      { name: "신용취약소상공인 온라인 교육", url: "https://edu.sbiz.or.kr/edu/channel/alei2017/main.do" },
      ...
      { name: "한국직업능력진흥원", url: "https://www.hrdkorea.or.kr/" },
    ],
  },
  {
    key: "tools",
    ...
    sites: [
      ...
      { name: "한국신용정보원", url: "https://www.kcredit.or.kr/" },
      { name: "소상공인365 (빅데이터 상권분석)", url: "https://bigdata.sbiz.or.kr/" },
      { name: "대출 이자 계산기", url: "https://fine.fss.or.kr/fine/fnctip/lonCalc/view.do?menuNo=900019" },
      { name: "올크레딧 대출 조회", url: "https://www.allcredit.co.kr/" },
      { name: "네이버페이 마이비즈", url: "https://finsupport.naver.com/" },
      { name: "통계분류포털", url: "http://kssc.kostat.go.kr/" },
    ],
  },
  {
    key: "cert",
    ...
    label: "인증·확인서·법인 관리",
    sites: [
      { name: "홈택스(증명·사실증명 발급)", url: "https://www.hometax.go.kr/" },
      { name: "인터넷 등기소", url: "https://www.iros.go.kr/" },
      { name: "4대보험 통합징수포털", url: "https://si4n.nhis.or.kr/" },
      { name: "고용·산재보험 토탈서비스", url: "https://total.comwel.or.kr/" },
      ...
      { name: "수출바우처", url: "https://www.exportvoucher.com/portal/sample/main" },
      { name: "중소기업확인서", url: "https://sminfo.mss.go.kr/" },
      { name: "한국무역협회 수출실적증명", url: "https://membership.kita.net/cert/oncert/expImpCertGuide.do" },
      { name: "무역통계 정보포털 TRASS", url: "https://www.bandtrass.or.kr/" },
      { name: "구매확인서 통합정보서비스", url: "https://ulocal.utradehub.or.kr/" },
      { name: "창업기업확인시스템", url: "https://cert.k-startup.go.kr/" },
      { name: "여성기업 종합정보 포털", url: "https://wbiz.or.kr/" },
      { name: "중소기업제품 종합정보망", url: "https://www.smpp.go.kr/" },
      { name: "사회적기업 포털", url: "https://www.seis.or.kr/" },
      { name: "벤처확인시스템", url: "https://www.smes.go.kr/venturein/" },
      { name: "국가뿌리산업진흥센터", url: "https://www.kpic.re.kr/" },
      { name: "INNOBIZ", url: "https://www.innobiz.net/" },
      { name: "MAINBIZ", url: "https://www.smes.go.kr/mainbiz/" },
