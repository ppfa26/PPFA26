...
const CASES: CaseItem[] = [
  {
    ...
    strategy: [
      "당장 신청이 불가하다는 걸 누구보다 잘 알고 있었기에, 좋은 기업으로 하나씩 바꿔나가는 자문부터 시작했습니다. 당장 받을 수 있는 정부지원사업은 전무하기 때문에 일단 재무제표상 문제점을 해결해 나갔고 벤처기업인증(혁신성장유형) 준비와 재무제표 흑자전환을 목표로 준비해 나갔습니다.",
      "기존 음반·굿즈 홈페이지를 AI 맞춤 추천 및 관리 시스템을 갖춘 형태로 재구축해 혁신성장유형으로 신청 → 1차 부결 후, 2차 보완·이의제기로 승인받았습니다.",
      "국세·지방세 미납/체납도 일부 있어 먼저 정리했고, 재무제표 보완이 끝난 다음 해에 정부지원사업 신청 자격을 확보했습니다.",
      "벤처인증을 무기로 연초\n수출바우처 1억 승인을 시작으로\n→ 중소벤처진흥공단 신시장진출자금 연계 2억 승인\n→ 무역보험공사 문화산업보증 10억 신청 후 5억 승인\n→ 마지막으로 소상공인시장진흥공단 혁신성장촉진자금(수출 소상공인) 7000만원까지\n순차적으로 정부지원사업을 확보할 수 있도록 자문을 해드렸습니다.",
    ],
    result: [
      "불필요한 판관비를 줄이고 놓친 매입을 잡고\n추가적인 제휴 세무사님의 노력으로\n다음 결산에서 흑자전환에 성공했습니다.",
      "그 후 정부지원사업은 아래와 같은 순서로 진행했으며",
      "중기부 수출바우처 1억\n중소벤처기업진흥공단 신시장진출자금 2억\n무역보험공사 문화산업보증 5억\n소상공인시장진흥공단 혁신성장촉진자금(수출 소상공인) 5,000만원\n총 8억 5천만 원의 정부지원사업을 승인받고 확보하는데 도움을 드렸습니다.",
    ],
    beyond: [],
    funds: [
