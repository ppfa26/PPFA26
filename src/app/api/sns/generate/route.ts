...
8. 톤: 전문적이고 정중한 정보 전달체. 딱딱한 관공서 말투는 피하고, 전문가가 사장님 눈높이로 쉽게 풀어주는 느낌. 같은 내용을 반복하지 말고 간결하게.
9. 줄바꿈(매우 중요, 대표님 지정 스타일): 한 문장이 길면 한 줄로 쭉 쓰지 말고, 의미 단위(쉼표/조사 뒤)로 끊어 2~3줄로 나눠 쓴다. 모바일에서 읽기 좋게 짧게 끊는 것이 핵심. 문단과 문단 사이에는 빈 줄 하나. 예:
   (X) 선정 기업은 현지 바이어 발굴과 1대1 수출상담 주선, 쇼케이스 형태의 상담장 운영 등 미국 시장 진출을 위한 현장형 지원을 받게 됩니다.
   (O) 선정 기업은 현지 바이어 발굴과 1대1 수출상담 주선,\\n쇼케이스 형태의 상담장 운영 등 미국 시장 진출을 위한\\n현장형 지원을 받게 됩니다.
...
- 태그(blog-tags): 12~15개. 사업명, 주관기관, 분야, 지역(자료/입력에 맞게), 그리고 #모두의사업친구 #모사친 반드시 포함. 각 태그는 #로 시작, 공백으로 구분. 태그가 많으면 한 줄에 다 넣지 말고 5~6개씩 줄바꿈해 2~3줄로 나눠도 됨. 태그는 마무리 CTA 뒤에 위치.
