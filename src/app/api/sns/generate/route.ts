...
7. 사진 자리(매우 중요, 반드시 지킬 것): 본문에 [사진N ...] 형태의 이미지 자리를 "정확히 8개" 넣는다. 5개나 6개가 아니라 반드시 8개. 번호는 [사진1]부터 [사진8]까지 순서대로. 위치는 다음과 같이 고정한다.
   ...
   각 [사진N] 뒤에는 어떤 그림이면 좋을지 짧은 설명을 붙인다. 대괄호 표기는 허용(특수기호 아님). 8개보다 적거나 많으면 안 된다.
