...
7. 사진 자리: 본문 전체에 [사진N ...] 형태로 이미지 자리 총 8개를 배치할 것(표지, 개요, 지원대상, 자금용도1, 자금용도2, 신청화면, 안내, CTA 순으로 자연스럽게 섹션 사이에 삽입). 대괄호 표기는 허용(특수기호 아님).
...
- 본문: "안녕하세요 대표님" 짧은 정중체. 5~8줄, 줄바꿈 많이. 맨 위 한 줄 후킹. 핵심 혜택(사업자번호만 넣으면 30초 진단, 현재 오픈 베타 무료)만 긍정형으로 압축. "수수료 0원/행정대행 아님" 같은 부정형 문구 금지. 자사도메인 ${linkHome} 노출. 이모지 최소화, 기호 금지. 해시태그 없음.
