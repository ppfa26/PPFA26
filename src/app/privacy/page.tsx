    ...
    >
      ...
      <section id="privacy-1">
        ...
        <ul className="mt-3 list-disc space-y-1.5 pl-5">
          <li>
            <b>웹 무료 진단 시</b>: 사업 형태·업종·매출 규모·소재지 등 진단 응답
            정보 (웹 무료 진단 단계에서는 이름·연락처 등 개인 식별 정보를
            수집하지 않습니다)
          </li>
          <li>
            <b>토스 미니앱(모두의사업친구) 진단 신청 시</b>: 사업자등록번호,
            성함, 연락처(전화번호), 사업 형태·업종·매출 규모·소재지 등 진단 응답
            정보
          </li>
          <li>
      ...
      <section id="privacy-2">
        ...
        <ul className="mt-3 list-disc space-y-1.5 pl-5">
          ...
          <li>
            <b>정부지원사업 진단 결과 안내 및 상담 연결</b>(토스 미니앱 등에서
            수집한 사업자등록번호·성함·연락처 활용)
          </li>
