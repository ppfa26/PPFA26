...
const REVIEWS: Review[] = [
  {
    ...
    channel: "당근마켓",
    rating: 5,
    title: "부결됐던 자금, 여기서 승인받았습니다",
    body: "다른 곳에서 두 번이나 부결돼서 반신반의하며 상담받았는데, 우리 회사 상황에 딱 맞는 상품을 찾아주셨어요. 서류부터 심사까지 하나하나 챙겨주셔서 결국 소상공인 정책자금 직접대출 승인 완료됐습니다. 진작 올 걸 그랬어요.",
    result: "소상공인 정책자금 직접대출 승인",
  },
  {
    name: "이O진 대표",
    business: "도소매업",
    ...
    body: "처음엔 무료라 큰 기대 안 했는데, 350가지 상품 중에 제 조건에 맞는 걸 정확히 짚어주시더라고요. 보증드림 약정까지 무사히 마무리했습니다. 자금 때문에 밤잠 설쳤는데 한시름 놓았습니다.",
    result: "지역신용보증재단 보증 약정 완료",
  },
  {
    name: "박O수 대표",
    business: "수출 제조기업",
  ...
  },
  {
    ...
    channel: "당근마켓",
    rating: 5,
    title: "혁신사업지원센터 때부터 믿고 맡깁니다",
    body: "예전 상호(혁신사업지원센터)일 때 첫 상담받고 승인받았어요. 이번에 매장 하나 더 낼 때도 다시 찾았습니다. 이름은 모두의공공조달로 바뀌었지만 꼼꼼하게 챙겨주시는 건 여전하네요. 믿고 맡길 수 있는 곳입니다.",
    result: "특례보증 + 운전자금 승인",
  },
  {
    name: "최O민 대표",
  ...
  },
  {
    ...
    body: "대표번호로 전화 한 통 드린 게 시작이었는데, 우리 회사 등급이랑 상황 다 검토해서 가능한 자금을 쭉 정리해주셨어요. 부담 없이 상담받은 게 실제 지급 완료로 이어졌습니다. 감사합니다.",
    result: "정책자금 지급 완료",
  },
];

const STATS = [
  { label: "누적 자금·바우처 승인", value: "1,000건+" },
  { label: "부결 시 컨설팅비", value: "100% 환불" },
  { label: "취급 지원상품", value: "350종" },
  { label: "무료 상담", value: "언제나" },
];
      ...
      <main className="mx-auto w-full max-w-5xl px-4 pb-20 pt-10 sm:px-6">
        ...
        <section className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl break-keep text-sm leading-relaxed text-brand-gray sm:text-base">
            ...
            은 옛 <span className="font-semibold">혁신사업지원센터(IBSC)</span> 시절부터
            쌓아온 노하우로, 3년간 약 1,000여 기업의 자금 고민을 함께 풀어왔습니다.
            아래는 당근마켓·네이버 블로그·카카오 상담을 통해 만난 대표님들의 실제 후기입니다.
          </p>
        </section>
