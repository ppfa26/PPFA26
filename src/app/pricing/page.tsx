...
const PRICING_FAQ = [
  ...
  {
    q: "Q2. 행정대행 신청해주시나요?",
    a: "아닙니다. 저희는 정부지원사업 AI 통합 매칭 플랫폼입니다. 서류 발급부터 신청은 대표님이 직접 진행하시게 됩니다. 신청 가능한 정부지원사업을 추천 및 안내해드리는 서비스를 제공합니다.",
  },
  {
    q: "Q3. 승인을 보장하나요?",
    a: "아닙니다. 저희는 정부지원사업 AI 통합 매칭 플랫폼으로써 정부지원사업 추천 및 안내를 해드리는 서비스며 자금 승인 여부는 정부 기관의 심사에 따라 결정됩니다. 승인을 보장하지 않습니다.",
  },
  {
    q: "Q4. 승인후 추가 수수료가 있나요?",
    a: "없습니다. 모두의사업친구 서비스 이용료 외 추가적인 수수료는 없습니다.",
  },
  {
    q: "Q5. 환불되나요?",
  ...
  },
  {
    ...
    a: "정부 지원금 및 각종 바우처, 지원제도 및 감면제도, 청년창업사관학교, K-Startup, 예비/초기창업패키지, 창업대학, 지자체 지원사업, 각종 인증제도까지 국내 모든 정부지원사업을 포괄 안내를 목표로합니다.",
  },
  {
    q: "Q7. 정보는 얼마나 최신인가요?",
    a: "매일 자동으로 정부 각 기관 공식 사이트를 크롤링하여 최신 공고를 반영합니다. 또한 관련 부처의 최신 공문 자료를 기반으로 정확한 팩트체크 후 답변합니다.",
  },
];
