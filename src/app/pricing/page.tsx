...
const PRICING_FAQ = [
  ...
  {
    q: "Q2. 행정대행 신청해주시나요?",
    a: "아닙니다. 저희는 방법을 알려드리는 경영 자문 플랫폼입니다. 서류 발급부터 신청까지는 대표님이 직접 진행하시게 됩니다. 신청 방법만 정확히 아신다면 직접 신청도 충분히 가능합니다.",
  },
  {
    q: "Q3. 승인을 보장하나요?",
  ...
  },
  {
    ...
    a: "없습니다. 저희는 사업장에 알맞는 정부지원사업을 AI로 찾아서 추천 및 신청방법을 자문해드리는 플랫폼이며 모두의사업친구 서비스 이용료 외 추가적인 수수료는 없습니다.",
  },
  {
    q: "Q5. 환불되나요?",
