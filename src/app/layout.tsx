  ...
  "@graph": [
    {
      ...
      // ★ 동명이(異) 사업 구분(disambiguation) ★
      //  구글이 브랜드명 "모두의사업친구"를 정부 대형 프로젝트 "모두의 창업"이나
      //  서울시복지재단 "모두의 친구"와 혼동해 그쪽 결과로 덮어버리는 것을 막기 위해,
      //  우리가 이들과 무관한 '별개의 민간 브랜드'임을 검색엔진에 명시적으로 각인시킨다.
      disambiguatingDescription:
        "'모두의사업친구'는 정부 창업 오디션 '모두의 창업'(중소벤처기업부)이나 복지 사업 '모두의 친구'와 전혀 무관한, 소상공인·중소기업을 위한 독립 민간 정부지원사업 AI 매칭 플랫폼 브랜드입니다.",
      // ★ 독립 브랜드 신호 ★ - 구글이 별도 브랜드 엔티티로 인식하도록 명시
      brand: {
        "@type": "Brand",
        name: "모두의사업친구",
        alternateName: "모두의 사업친구",
