...
const CHANNELS = [
  ...
  { href: "https://www.instagram.com/mosachin_official", label: "인스타그램", svg: SI.instagram, hover: "hover:border-[#E1306C]/70 hover:bg-[#E1306C]/15 hover:text-[#E1306C]" },
  { href: "https://www.threads.com/@mosachin_official", label: "스레드", svg: SI.threads, hover: "hover:border-white/60 hover:bg-white/10 hover:text-white" },
  ...
  { href: "https://link.inpock.co.kr/mosachin", label: "인포크링크", fa: "fa-solid fa-link", hover: "hover:border-brand-orange/70 hover:bg-brand-orange/15 hover:text-brand-orange" },
];
