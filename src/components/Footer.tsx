...
const CHANNELS = [
  ...
  { href: "https://www.instagram.com/mosachin", label: "인스타그램", svg: SI.instagram, hover: "hover:border-[#E1306C]/70 hover:bg-[#E1306C]/15 hover:text-[#E1306C]" },
  { href: "https://www.threads.com/@mosachin", label: "스레드", svg: SI.threads, hover: "hover:border-white/60 hover:bg-white/10 hover:text-white" },
