...
import { BETA_FREE, OPEN_ALERT_URL } from "@/lib/betaConfig";
        ...
        {TIERS.map((tier) => (
          ...
          >
            ...
            <div className="mt-2">
              {BETA_FREE ? (
                <>
                  {/* 오픈 베타: 정식 오픈 예정가(앵커) → 지금은 무료 */}
                  <div className="flex items-center gap-2">
                    <span className="text-[11px] font-semibold text-brand-dark/60">
                      정식 오픈 예정가
                    </span>
                    <span
                  ...
                  <div className="mt-0.5 flex items-end gap-1">
                    <span className="text-[26px] font-black leading-none text-brand-green">
                      무료
                    </span>
                    <span className="mb-1 break-keep text-sm font-bold text-brand-green">
                      오픈 베타 기간 한정
                    </span>
                  </div>
                  <p className="mt-1 break-keep text-[11px] text-brand-gray">
                    * 정식 오픈 시 {tier.priceLabel}(VAT 포함)로 전환 예정
                  </p>
                </>
              ) : (
                <>
            ...
            {BETA_FREE ? (
              <div className="mt-4 space-y-2">
                <Link
                  href="/diagnosis"
                  className="block rounded-full bg-brand-green py-2.5 text-center text-sm font-bold text-white hover:opacity-90"
                >
                  🎉 지금 무료로 시작하기
                </Link>
                <a
                  ...
                  className="block rounded-full border border-brand-dark/20 bg-white py-2.5 text-center text-sm font-bold text-brand-dark hover:bg-gray-50"
                >
                  🔔 정식 오픈 알림 받기
                </a>
              </div>
